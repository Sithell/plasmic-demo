...
import ToggleButton from "../../ToggleButton"; // plasmic-import: k1G7imPD1Qer/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: p6F3usyyzBAKqeh7KTGsym/projectcss
import sty from "./PlasmicFooter.module.css"; // plasmic-import: I6boUc6FMm81/css
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__b97Z3, {
            [sty.freeBoxstate_empty__b97Z3DJBt]: hasVariant(
              $state,
              "state",
              "empty"
            ),
            [sty.freeBoxstate_hasCompleted__b97Z3Sb2Ze]: hasVariant(
              $state,
              "state",
              "hasCompleted"
            ),
            [sty.freeBoxstate_singularLeft__b97Z3GW37Y]: hasVariant(
              $state,
              "state",
              "singularLeft"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__ghdfT,
              {
                [sty.textstate_empty__ghdfTdJBt]: hasVariant(
                  $state,
                  "state",
                  "empty"
                ),
                [sty.textstate_hasCompleted__ghdfTsb2Ze]: hasVariant(
                  $state,
                  "state",
                  "hasCompleted"
                ),
                [sty.textstate_singularLeft__ghdfTgW37Y]: hasVariant(
                  $state,
                  "state",
                  "singularLeft"
                )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__gYiDm)}
      >
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__kTpHi)}
          onClick={async () => {
            const $steps = {};
        ...
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__xXcRr)}
          onClick={async () => {
            const $steps = {};
        ...
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__kwo3B)}
          onClick={async () => {
            const $steps = {};
      ...
      {(hasVariant($state, "state", "hasCompleted") ? true : false) ? (
        <div
          className={classNames(
            ...
            sty.text__tvPwG,
            {
              [sty.textstate_hasCompleted__tvPwGsb2Ze]: hasVariant(
                $state,
                "state",
                "hasCompleted"
              )
