...
// Plasmic Project: p6F3usyyzBAKqeh7KTGsym
// Component: 5R-xFTrBt_U4
...
import { ThemeValue, useTheme } from "./PlasmicGlobalVariant__Theme"; // plasmic-import: LJHFoirBXfGE/globalVariant

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: p6F3usyyzBAKqeh7KTGsym/projectcss
import sty from "./PlasmicTask.module.css"; // plasmic-import: 5R-xFTrBt_U4/css
...
function PlasmicTask__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__zwyNg, {
          [sty.freeBoxstate_editing__zwyNgDz8G4]: hasVariant(
            $state,
            "state",
            "editing"
          ),
          [sty.freeBoxstate_editing_global_theme_dark__zwyNgDz8G4SUpzg]:
            hasVariant($state, "state", "editing") &&
            hasVariant(globalVariants, "theme", "dark")
        })}
      >
        {(hasVariant($state, "state", "editing") ? false : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox__tQFwR, {
              [sty.freeBoxstate_checked__tQFwRhtRlp]: hasVariant(
                $state,
                "state",
                "checked"
              ),
              [sty.freeBoxstate_checked_global_theme_dark__tQFwRhtRlpSUpzg]:
                hasVariant($state, "state", "checked") &&
                hasVariant(globalVariants, "theme", "dark"),
              [sty.freeBoxstate_editing__tQFwRDz8G4]: hasVariant(
                $state,
                "state",
                "editing"
              )
            ...
            onClick={async event => {
              ...
              $steps["postgresUpdateMany"] = true
                ? (() => {
                    const actionArgs = {
                      dataOp: {
                        sourceId: "wYx1NKPiqgAtiRqw2AJjXH",
                        opId: "9ba26a12-45d7-4629-8cf7-15eb099033b0",
                        userArgs: {
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__bQfwU, {
          [sty.freeBoxglobal_theme_dark__bQfwUsUpzg]: hasVariant(
            globalVariants,
            "theme",
            "dark"
          ),
          [sty.freeBoxstate_editing__bQfwUDz8G4]: hasVariant(
            $state,
            "state",
            "editing"
          ),
          [sty.freeBoxstate_editing_global_theme_dark__bQfwUDz8G4SUpzg]:
            hasVariant($state, "state", "editing") &&
            hasVariant(globalVariants, "theme", "dark")
        })}
      >
        {(hasVariant($state, "state", "editing") ? false : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox__epGbv, {
              [sty.freeBoxstate_checked__epGbvHtRlp]: hasVariant(
                $state,
                "state",
                "checked"
              ),
              [sty.freeBoxstate_editing__epGbvDz8G4]: hasVariant(
                $state,
                "state",
                "editing"
              )
                ...
                $steps["tutorialdbUpdateMany"] = true
                  ? (() => {
                      const actionArgs = {
                        dataOp: {
                          sourceId: "wYx1NKPiqgAtiRqw2AJjXH",
                          opId: "fed67941-fdef-4897-ab4b-d4a978c2e5e2",
                          userArgs: {
                            conditions: [$props.task.id],
              ...
              $steps["postgresUpdateMany"] = true
                ? (() => {
                    const actionArgs = {
                      dataOp: {
                        sourceId: "wYx1NKPiqgAtiRqw2AJjXH",
                        opId: "a6719955-52cb-43d2-820a-b1af54910650",
                        userArgs: {
                          variables: [$state.textbox.value],
                          conditions: [$props.task.id]
                        },
        ...
        {(hasVariant($state, "state", "editing") ? false : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox__oslR, {
              [sty.freeBoxstate_editing__oslRDz8G4]: hasVariant(
                $state,
                "state",
                "editing"
              )
                ...
                $steps["postgresDeleteMany"] = true
                  ? (() => {
                      const actionArgs = {
                        dataOp: {
                          sourceId: "wYx1NKPiqgAtiRqw2AJjXH",
                          opId: "60f5540b-8d6f-4319-b515-21f3210b0964",
                          userArgs: {
                            conditions: [$props.task.id]
                          },
                          cacheKey: null,
